...
6. CT(Common Table Expression)

# Project's Objective:
-> It is a retail busineses data set. 
-> The general idea of this project is to identify key problems and finding the answers to it.
...
4. Create each shift and number of orders (Example Morning <12, Afternoon Between 12 & 17, Evening >17)transactions (transaction_id) made by each gender in each?
